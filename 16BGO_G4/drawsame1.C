void drawsame1()
{
  ...
  TFile *f2 = new TFile("eff_300convert.root"); // 黑色谱
  ...
  t1->Draw("singleInner>>h1(600,100,6100)", "sumOuter==0&&anti==0");
  t2->Draw("singleInner>>h2(600,100,6100)", "sumOuter==0");

  // t1->Draw("sumInner>>h1(500,100,10100)", "");
  // t2->Draw("sumInner>>h2(500,100,10100)", "");
  ...
  legend->AddEntry(h1, "run00715_cal", "f");
  legend->AddEntry(h2, "eff_300convert", "l");
